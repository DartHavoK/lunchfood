...
<?php 
    ...
    $sql_platillos="SELECT `id_platillo`,`categoria_platillo`,`nombre_platillo` FROM `platillo` WHERE `nombre_platillo`NOT LIKE 'Ninguno' AND `categoria_platillo` = 2 ORDER BY `nombre_platillo`  ";
...
$sql_idplatillo="SELECT `id_platillo`,`categoria_platillo` FROM `platillo` WHERE `nombre_platillo` NOT LIKE 'Ninguno' AND  `categoria_platillo` = 2 ORDER BY `id_platillo` ASC";
...
window.location="escandallo_editar.php?cat_platillo=2&id_platillo=<?php echo $autorefresh['id_platillo']; ?>&id_rel=<?php echo $autorefresh['id_relacion']; ?>&id_ingre=<?php echo $autorefresh['id_ingrediente']; ?>&autorefresh=1";
</script>"
...
//fin auto refresh ?>
  ...
  <!--<ul class="sidenav" id="mobile-demo">
    ...
    <div  class="col s12">
       ...
       <div class="center"><a href="nuevo_platillo.php" class="center waves-effect waves-light btn">Añadir nuevo platillo principal</a></div>
        </br>
        </br>
        </br>
