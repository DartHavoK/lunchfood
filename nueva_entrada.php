...
<script src="js/jquery-3.3.1.js"></script>
    ...
    <div class="container">
    <h2>Ingresar nueva entrada</h2>
        
    <form id="platillos" method="post" action="datosentrada.php" enctype="multipart/form-data">
    <div class="row">
      <div class="input-field col m6 s12">
        <input id="nombreingrediente" name="nombreingrediente" type="text" class="validate" required>
        <label class="active" for="first_name2">Nombre de la entrada</label>
      </div>
    </div>
      <div class="row">
    ...
    <div class="container center-align">
        <div class="row">
            <div class="col s6">
                <button class="btn-large waves-effect waves-light" type="submit" name="action" form="platillos">Subir entrada
