<?php
    ...
    $sql_insertar="INSERT INTO `platillo` (`id_platillo`,`id_unidad`, `nombre_platillo`, `porciones`, `tamaño_porciones`, `tiempo_preparacion`, `costo_neto`, `costo_bruto`, `paxpla_pesos`, `paxpla_porciento`, `instr`,`instructivo_empaquetado`) VALUES (NULL, '$uingrediente', '$nombreplatillo', '$porciones','$tamaño_porciones', '$tiempo', '', '', '', '', '$instrucciones','$instrucciones_empaquetado');";
