...
<div class="container"><!--Inicia HTML-->
    ...
    <div class="row">        
        ...
        <h5><b>Número de lotes a emplatar: </b> <?php echo $num_lotes['numerolotes']; ?> </h5>
    </div>-->
    ...
    <div class="row">
        <div class="col m12 s12"><!--Genera escandallo entradas-->
            <div class="row">
                <div class="col m6 s12">
                  ...
                  echo $porciones_entrada['des_unidad']; ?></h6> <!-- Atraccion segun el id de la tabla platillo -->
                    <h6><b>Empaque 1 :</b> <?php echo $menu['empaq1']; ?> </h6>
                </div>
            </div>
            <div class="row">
                <div class="col m6">
                    <?php
                        $id_imagen = $id; 
                          $path1 = "foto_menus/empaquetado/entrada/".$id_imagen."/";
                          if(file_exists($path1)){
                            $directorio = opendir($path1);
                            while ($archivo1 = readdir($directorio))
                            {
                              if (!is_dir($archivo1)){
                                echo "<img src='".$path1.$archivo1."' width='350' />";
                            }
                          }
                        }
                    ?>
                ...
                <div class="col m6">
                    <?php 
                          $path2 = "foto_menus/presentacion/entrada/".$id_imagen."/";
                          if(file_exists($path2)){
                            $directorio = opendir($path2);
                            while ($archivo2 = readdir($directorio))
                            {
                              if (!is_dir($archivo2)){
                                echo "<img src='".$path2.$archivo2."' width='350' />";
                            }
                          }
                        }
                    ?>
    ...
    <hr/>           
        <div class="col m6 s12">
            ...
            <h6><b>Empaque 2 :</b> <?php echo $menu['empaq2']; ?> </h6>                   
        </div>
        <div class="col m3 s12"><!--Genera escandallo Guarnición 1-->
    ...
    <div class="row"> 
        <div class="col m6 s12">
            <?php
                  $path3 = "foto_menus/empaquetado/fuerte/".$id_imagen."/";
                  if(file_exists($path3)){
                    $directorio = opendir($path3);
                    while ($archivo3 = readdir($directorio))
                    {
                      if (!is_dir($archivo3)){
                        echo "<img src='".$path3.$archivo3."' width='350' />";
                    }
                  }
                }
            ?>
        ...
        <div class="col m6 s12">
            <?php
                  $path4 = "foto_menus/presentacion/fuerte/".$id_imagen."/";
                  if(file_exists($path4)){
                    $directorio = opendir($path4);
                    while ($archivo4 = readdir($directorio))
                    {
                      if (!is_dir($archivo4)){
                        echo "<img src='".$path4.$archivo4."' width='350' />";
                    }
                  }
                }
            ?>
