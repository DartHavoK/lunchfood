      ...
      <?php 
        ...
        $sql_unidades=" SELECT * FROM `unidad` WHERE `id_unidad`";
        $resultado = mysqli_query($link,$sql_unidades) or die(mysqli_error($link));

        $sql_ultimoid=" SELECT MAX(id_ingredientes) AS id_ingredientes FROM `ingredientes` ";
    ...
    <div class="row" style="visibility: hidden;">
        <div class="col m12 s12" >
            <input type="number" value="<?php echo $id['id_ingredientes']+1; ?>" id="ultimo_id" name="ultimo_id" readonly>
        </div>
    </div>
    <div class="row">
    ...
    <div class="input-field col m6 s12 center">
        <input id="cant_almacen" name="cant_almacen" type="number" value="0"  step="any">
        <label class="active" for="first_name2">Cantidad en almacen</label>
    </div>

    <div class="input-field col m6 s12 center">
        <input id="resurtido" name="resurtido" type="number" value="0"  step="any">
        <label class="active" for="first_name2">Punto de resurtido</label>
    </div>
    <div class="input-field col m6 s12 center">
        <input id="cant_max" name="cant_max" type="number" value="0"  step="any">
