<?php
	...
	*/
	...
	$aColumnas = array('id', 'usuario', 'nombre', 'correo', 'id_tipo', 'area_trabajo', 'activacion' );
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='#' data-href='eliminar_registro.php?id=".$aRow['id']."' data-toggle='modal' data-target='#confirm-delete'><span class='glyphicon glyphicon-trash'></span></a></td>";
